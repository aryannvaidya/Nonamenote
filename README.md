...
4. The note passes through **AI moderation** (Hugging Face) to filter toxic content (not 100% safe, as human beings find a way to bypass any restriction somehow, so be respectful towards the recipient 🙏)
